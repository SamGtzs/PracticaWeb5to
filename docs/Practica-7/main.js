...
function validateForm(e) {
  ...
  if ($nameInput.value.trim() === "") {
    ...
    $nameError.innerText = "El formato del nombre no es valido";
    isValid = false;
  }
  ...
  if ($passwordInput.value.trim() === "") {
    ...
    $passwordError.innerText = "La contraseña debe tenr almenos un numero, una letra minuscula y un caracter especial"
    isValid = false;
  }
